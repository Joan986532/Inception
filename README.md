...
1: First of all, you'll need Docker Engine, otherwise you won't be able to use the docker commands. Follow this tutorial to install it: 
    https://docs.docker.com/engine/install

2: Now in the terminal, go in the Inception folder and use the 'make' command. All the docker commands we need are linked in the Makefile.
    This will build all the containers, the volumes and link them.
